...
declare module "@salesforce/schema/User.Email__c" {
  const Email__c:string;
  export default Email__c;
}
declare module "@salesforce/schema/User.Image__c" {
  const Image__c:string;
  export default Image__c;
}
declare module "@salesforce/schema/User.Profession__c" {
  const Profession__c:string;
  export default Profession__c;
}
declare module "@salesforce/schema/User.Rank__c" {
